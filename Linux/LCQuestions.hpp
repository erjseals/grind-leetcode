...
private:
public:
  // letterCominations returns a std::vector<std::string> that contains all
  // possible std::strings given a numerical combination. This is like t9
  // texting. Example would be input "45" and returns "gj", "gk", "gl", "hj",
  // "hk", "hl", "ij", "ik", "il"
  ...
  // Given n pairs of parentheses, this function generates all combinations of
  // well-formed parentheses.
  std::vector<std::string> generateParenthesis(int n);

  // Helper for generateParenthesis
  void genParenHelper(std::vector<std::string> &vec, std::string str, int l,
                      int r);
